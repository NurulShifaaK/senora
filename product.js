...
rightArrow1=document.getElementById("rightArrow1");
leftArrow1=document.getElementById("leftArrow1");
shirtWrapper=document.getElementById("shirtWrapper");

const scrollAmount = 300;

rightArrow1.addEventListener('click', () => {
 shirtWrapper.scrollLeft += scrollAmount;
...
rightArrow2=document.getElementById("rightArrow2");
leftArrow2=document.getElementById("leftArrow2");
tshirtWrapper=document.getElementById("tshirtWrapper");
const scrollAmount1 = 300;

rightArrow2.addEventListener('click', () => {
 tshirtWrapper.scrollLeft += scrollAmount1;
});
...
rightArrow3=document.getElementById("rightArrow3");
leftArrow3=document.getElementById("leftArrow3");
shoeWrapper=document.getElementById("shoeWrapper")

const scrollAmount2 = 300;

rightArrow3.addEventListener('click', () => {
shoeWrapper.scrollLeft += scrollAmount2;
});
